...
const pageTitle = computed(() => {
  if (formData.currentStep === 1 || formData.currentStep === 2) {
    return "Conditions d'utilisation";
  }
  return "Prêt à partager pour débloquer l'achat ?";
});
...
const checkVerification = async () => {
  formData.isLoading = true;
  await new Promise(resolve => setTimeout(resolve, 1500));
  formData.verificationStatus = 'validated';
  formData.isLoading = false;
};
</script>
  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-lg">
      <div class="text-center mb-8">
        ...
        <p class="text-blue-200">{{ pageTitle }}</p>
      </div>

      <Transition name="slide-fade" mode="out-in">
        <div v-if="formData.currentStep === 0" class="glass-card">
          <img 
        ...
        <div v-else class="glass-card">
          <Transition name="slide-fade" mode="out-in">
            <div v-if="formData.currentStep === 1" class="text-center">
              <h3 class="text-xl text-blue-200 mb-6">Êtes-vous d'accord avec le fonctionnement ?</h3>
              <p class="text-blue-200 mb-8 text-center">
                Tu es d'accord avec le fonctionnement d'une chaîne de partage ? Pour éviter la triche nous facturons 
                un premier paiement de 50% du prix de l'article. Les 50% restants seront débités une fois qu'un autre 
                utilisateur valide ton achat.
              </p>
              <div class="space-y-4">
                <label class="flex items-center justify-center gap-4 cursor-pointer">
                  ...
                  <span class="text-blue-200">J'accepte le principe de la chaîne de partage</span>
                </label>
              </div>
            </div>

            <div v-else-if="formData.currentStep === 2" class="text-center">
              <h3 class="text-xl text-blue-200 mb-6">Êtes-vous d'accord avec cette condition ?</h3>
              <p class="text-blue-200 mb-8 text-center">
                Si tu n'arrives pas à trouver une autre personne, alors le prix d'achat sera fixé au prix initial soit 62,00€.
              </p>
              <div class="space-y-4">
                <label class="flex items-center justify-center gap-4 cursor-pointer">
                  <input 
                  ...
                  />
                  <div class="custom-checkbox"></div>
                  <span class="text-blue-200">J'accepte de payer le prix initial si aucune personne ne valide</span>
                </label>
              </div>
            </div>

            <div v-else-if="formData.currentStep === 3">
              <PaymentInput
            ...
            <div v-else-if="formData.currentStep === 4">
              <PaymentInput
            ...
            <div v-else-if="formData.currentStep === 5">
              <PaymentInput
            ...
            <div v-else-if="formData.currentStep === 6">
              <PaymentInput
            ...
            <div v-else-if="formData.currentStep === 7">
              <PaymentInput
            ...
            <div v-else-if="formData.currentStep === 8">
              <PaymentInput
            ...
            <div v-else-if="formData.currentStep === 9">
              <PaymentInput
            ...
            <div v-else-if="formData.currentStep === 10" class="text-center">
            ...
            <div v-else-if="formData.currentStep === 11" class="text-center">
            ...
            <div v-else-if="formData.currentStep === 12" class="text-center">
