...
const copyLink = async () => {
  const link = 'share.daftlinkcom/festivalelectronique/01';
  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-lg">
      <div class="text-center mb-8">
        ...
        <p v-if="formData.currentStep === 0" class="text-blue-200">Prêt à partager pour débloquer l'achat ?</p>
      </div>

      <Transition name="slide" mode="out-in">
        <div v-if="formData.currentStep === 0" key="step-0">
        ...
        <div v-else class="glass-card" :key="`step-${formData.currentStep}`">
          <div v-if="formData.currentStep === 1" class="text-center">
            <h2 class="text-2xl text-white mb-4">Êtes-vous d'accord avec le fonctionnement ?</h2>
            <p class="text-xl text-white mb-4">Pour éviter la triche nous facturons un premier paiement de 50% du prix de l'article. Les 50% restants seront débités une fois qu'un autre utilisateur valide ton achat.</p>
            <div class="space-y-4">
          ...
          <div v-if="formData.currentStep === 2" class="text-center">
            <h2 class="text-2xl text-white mb-4">Êtes-vous d'accord avec cette condition ?</h2>
            <p class="text-blue-200 mb-6">Si tu n'arrives pas à trouver une autre personne, alors le prix d'achat sera fixé au prix initial soit 62,00€.</p>
            <div class="space-y-4">
              <label class="flex items-start gap-3 cursor-pointer">
                <input 
                  type="radio" 
          ...
          <div v-if="formData.currentStep === 11" class="text-center">
            ...
            <div class="border border-dashed border-white/20 rounded-lg p-4 mb-6">
              <p class="text-blue-200 break-all">
                share.daftlinkcom/festivalelectronique/01
              </p>
            </div>
          ...
          <div v-if="formData.currentStep === 12" class="text-center">
            <div class="flex flex-col items-center mb-6">
              ...
              <p v-if="formData.verificationStatus === 'validated'" class="text-green-400 mt-2 text-lg">
                Votre achat a été validé par Pierre Golin !
              </p>
            </div>
